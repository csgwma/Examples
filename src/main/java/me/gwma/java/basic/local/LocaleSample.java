package me.gwma.java.basic.local;
...
public class LocaleSample {
    public static String baseName = "me/gwma/java/basic/local/resource";
	...
	public static void resourceBoundle(){
        ResourceBundle rb1 = ResourceBundle.getBundle("me/gwma/java/basic/local/resource",Locale.US);
		ResourceBundle rb2 = ResourceBundle.getBundle("me/gwma/java/basic/local/resource",Locale.CANADA);
	...
	public static void resourceBoundleFmt(){
		ResourceBundle rb1 = ResourceBundle.getBundle("me/gwma/java/basic/local/fmt_resource",Locale.US);
		ResourceBundle rb2 = ResourceBundle.getBundle("me/gwma/java/basic/local/fmt_resource",Locale.CHINA);
